...
async def main():
    ...
    async with AsyncConnectionPool(conninfo=DB_URI, max_size=20, kwargs={"autocommit": True}) as pool:
        ...
        config = {"configurable": {"thread_id": "19_final_blog_test_with_images"},'run_name': "blog_writing_agent_run_25"}  # You can generate a unique thread_id for each conversation or use a fixed one for testing
