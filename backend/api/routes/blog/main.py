...
from api.routes.blog.delete_chat import router as delete_chat_router
from api.utils.auth import get_current_user


blog_router = APIRouter(
    prefix="/blog", tags=["Blog Generation"], dependencies=[Depends(get_current_user)]
)
...
blog_router.include_router(delete_chat_router)
